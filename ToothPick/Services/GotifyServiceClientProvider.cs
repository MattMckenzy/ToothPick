...
{
    public class GotifyServiceClientProvider(IDbContextFactory<ToothPickContext> toothPickContextFactory) : IRestServiceProvider
    {
        ...
        public async Task<string> GetToken()
        {
            ...
            string value = (await toothPickContext.Settings.GetSettingAsync("GotifyClientToken")).Value;
